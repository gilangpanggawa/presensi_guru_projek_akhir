  ...
  <div class="wrapper">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li align="center" class="well" style="">
              <a href="{{url('/')}}" class="btn btn-sm btn-dark form-control mb-1"><span class="glyphicon glyphicon-lock"></span> Website</a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ route('dashboard.index') }}" class="brand-link text-center">
        <span class="brand-text font-weight-light"><img src="{{ asset('logo/'. $konf->logo_setting) }}" style="width: 80px; align: center" alt=""></span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            ...
            @else
            <img src="{{ asset('logo/'. $konf->logo_setting) }}" class="img-circle elevation-2" alt="KG" style="width: 45px; height: 45px">
            @endif
          </div>
          <div class="info">
            <a href="#" style="font-size: 15px;" class="d-block "> {{ $konf->instansi_setting }}</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            {{-- Data Guru --}}
            <li class="nav-item">
              <a href="{{route('dataguru.index')}}" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <!-- <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('presensihadir.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Hadir</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('presensipulang.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Pulang</p>
                  </a>
                </li>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; <?php $cpy = date('Y');
                                echo $cpy; ?><a href=""> ITB Stikom Ambon</a>.</strong> All rights reserved.
    </footer>
