...
@section('content')
    ...
    <div class="col">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('presensihadir.store') }}" method="POST" enctype="multipart/form-data" id="form">
            @csrf
            @method('POST')
            <!-- id -->
        ...
        <div class="card-footer">
            ...
            <a href="{{route('presensihadir.index')}}" class="btn btn-warning btn-sm" >Data Presensi Hadir</a>
            </form>
        </div>
        </div>
    </div>
